...
DivCaseWorkerUser@AAT.com|CIC|NO_FAULT_DIVORCE|Submitted
TEST_CASE_WORKER_USER@mailinator.com|CIC|NO_FAULT_DIVORCE|Submitted
TEST_SOLICITOR@mailinator.com|CIC|NO_FAULT_DIVORCE|Submitted
divorce_as_caseworker_admin@mailinator.com|CIC|NO_FAULT_DIVORCE|Submitted
EOM
