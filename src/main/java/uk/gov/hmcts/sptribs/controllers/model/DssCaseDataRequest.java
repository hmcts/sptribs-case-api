...
public class DssCaseDataRequest {
    ...
    private List<ListValue<CitizenCICDocument>> dssCaseDataTribunalFormDocuments;

    private List<ListValue<CitizenCICDocument>> dssCaseDataSupportingDocuments;

    private List<ListValue<CitizenCICDocument>> dssCaseDataOtherInfoDocuments;
