...
public enum StayReason implements HasLabel {
    ...
    AWAITING_OUTCOME_OF_A_CIVIL_CASE("Awaiting outcome of civil case"),

    @JsonProperty("awaitingOutcomeOfCriminalProceedings")
    AWAITING_OUTCOME_OF_A_CRIMINAL_PROCEEDINGS("Awaiting outcome of criminal proceedings"),

    @JsonProperty("awaitingACourtJudgement")
    AWAITING_OUTCOME_OF_A_COURT_JUDGEMENT("Awaiting a court judgement"),

    @JsonProperty("unableToProgressDueToSubject’sAge")
    UNABLE_TO_PROGRESS_DUE_TO_SUBJECTS_AGE("Unable to progress due to subject’s age"),
    ...
    AWAITING_OUTCOME_OF_LINKED_CASE("Awaiting outcome of linked case"),
