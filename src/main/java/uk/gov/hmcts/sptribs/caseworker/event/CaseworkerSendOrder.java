...
@Component
@Slf4j
public class CaseworkerSendOrder implements CCDConfig<CaseData, State, UserRoleCIC> {
    ...
    public PageBuilder send(final ConfigBuilder<CaseData, State, UserRoleCIC> configBuilder) {
