...
public class CaseworkerDocumentManagementRemove implements CCDConfig<CaseData, State, UserRole> {
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        PageBuilder pageBuilder = new PageBuilder(configBuilder
            ...
            .grant(CREATE_READ_UPDATE_DELETE, SUPER_USER, ST_CIC_SENIOR_CASEWORKER,
                ST_CIC_HEARING_CENTRE_TEAM_LEADER)
            .grantHistoryOnly(ST_CIC_JUDGE, ST_CIC_SENIOR_JUDGE, ST_CIC_CASEWORKER, ST_CIC_HEARING_CENTRE_ADMIN)
