...
import uk.gov.hmcts.sptribs.common.event.page.RespondentPartiesToContact;
...
@Component
@Slf4j
public class CaseRespondentContactParties implements CCDConfig<CaseData, State, UserRole> {

    private static final CcdPageConfiguration respondentPartiesToContact= new RespondentPartiesToContact();
