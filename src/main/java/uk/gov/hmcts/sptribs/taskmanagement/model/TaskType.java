...
public enum TaskType {
    processCaseWithdrawalDirections(
        "Process case withdrawal directions",
        Processing, 7, SEND_ORDER_DESCRIPTION,
    ...
    processRule27Decision(
        "Process Rule 27 decision",
        Processing, 7, SEND_ORDER_DESCRIPTION,
        WorkType.ROUTINE_WORK.getLowerCaseName(),
        RoleCategory.ADMIN.name()),

    processRule27DecisionListed(
        "Process Rule 27 decision listed",
        Processing, 7, SEND_ORDER_DESCRIPTION,
        WorkType.ROUTINE_WORK.getLowerCaseName(),
        RoleCategory.ADMIN.name()),
    ...
    processListingDirections(
        ...
        Processing, 3, SEND_ORDER_DESCRIPTION,
        WorkType.ROUTINE_WORK.getLowerCaseName(),
        RoleCategory.ADMIN.name()),

    processListingDirectionsListed(
        "Process listing directions listed",
        Processing, 3, SEND_ORDER_DESCRIPTION,
        WorkType.ROUTINE_WORK.getLowerCaseName(),
        RoleCategory.ADMIN.name()),

    processDirectionsReListedCase("Process directions re. listed case",
        Hearing, 1, SEND_ORDER_DESCRIPTION,
        WorkType.ROUTINE_WORK.getLowerCaseName(),
        RoleCategory.ADMIN.name()),
