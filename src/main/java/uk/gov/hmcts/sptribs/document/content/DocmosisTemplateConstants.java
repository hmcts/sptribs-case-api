...
public final class DocmosisTemplateConstants {
    ...
    public static final String ME_DMI_MAIN_CONTENT =
        """
            ...
            1.     I have reviewed the available evidence and consider that it is necessary for <<SubjectRepFullName>> to be assessed by a Psychiatrist or \
            ...
            progress if the report has not been completed within 4 months of the issue of this notice. \
            3.     To <<SubjectRepFullName>>: Please could you ask your GP for a copy of all your records up to the present day. You are entitled to a copy \
            ...
            the GP records with your consent, although the cost of this may be deducted from any award. Please write to the Tribunal if you \
