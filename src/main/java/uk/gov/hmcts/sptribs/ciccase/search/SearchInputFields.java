...
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.ALTERNATIVE_SERVICE_TYPE;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_ADDRESS;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_EMAIL;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_FIRM_NAME;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_FIRST_NAME;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_HWF;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_1_LAST_NAME;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_2_ADDRESS;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.APPLICANT_2_EMAIL;
...
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.EVIDENCE_HANDLED;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.GENERAL_REFERRAL_URGENT_CASE;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.MARRIAGE_DATE;
import static uk.gov.hmcts.sptribs.ciccase.search.CaseFieldsConstants.URGENT_CASE;
