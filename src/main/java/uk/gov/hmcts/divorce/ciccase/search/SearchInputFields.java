package uk.gov.hmcts.divorce.ciccase.search;
...
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.ALTERNATIVE_SERVICE_TYPE;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_ADDRESS;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_EMAIL;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_FIRM_NAME;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_FIRST_NAME;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_HWF;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_1_LAST_NAME;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_2_ADDRESS;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_2_EMAIL;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_2_FIRST_NAME;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.APPLICANT_2_LAST_NAME;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.CASE_STATE;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.CCD_REFERENCE;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.EVIDENCE_HANDLED;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.GENERAL_REFERRAL_URGENT_CASE;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.MARRIAGE_DATE;
import static uk.gov.hmcts.divorce.ciccase.search.CaseFieldsConstants.URGENT_CASE;
