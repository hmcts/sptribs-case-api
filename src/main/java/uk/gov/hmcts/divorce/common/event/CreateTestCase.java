...
import uk.gov.hmcts.divorce.ciccase.model.RepresentativeCIC;
import uk.gov.hmcts.divorce.ciccase.model.RepresentativeCICDetails;
...
public class CreateTestCase implements CCDConfig<CaseData, State, UserRole> {
    ...
    private Map<String, String> getRepresentativeCic;
    ...
    public void configure(ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        if(RepresentativeCIC.REPRESENTATIVE.isRepresentativeCIC()){
        ...
        new PageBuilder(configBuilder
          ...
          //  .aboutToSubmitCallback(this::aboutToSubmit)
           ...
           // .optional(CicCase::getRepresentativeCic,"REPRESENTATIVE = \"true\"")
           ...
           // .optional(RepresentativeCICDetails:: getRepresentativeLegalQualification,"")
            .done();
    }
