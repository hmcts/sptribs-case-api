...
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_APP_2_DOMICILED;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_APP_2_LAST_RESIDENT;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_APP_2_RESIDENT;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_DOMICILED;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_RESIDENT_JOINT;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_RESIDENT_SIX_MONTHS;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_1_RESIDENT_TWELVE_MONTHS;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_2_DOMICILED;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_2_RESIDENT_JOINT;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.APP_2_RESIDENT_SOLE;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.RESIDUAL_JURISDICTION_CP;
import static uk.gov.hmcts.divorce.ciccase.model.JurisdictionConnections.RESIDUAL_JURISDICTION_D;
import static uk.gov.hmcts.divorce.ciccase.model.LanguagePreference.WELSH;
import static uk.gov.hmcts.divorce.ciccase.validation.ValidationUtil.EMPTY;
