...
import static uk.gov.hmcts.sptribs.caseworker.event.SystemMigrateOldHearing.SYSTEM_MIGRATE_OLD_HEARING;
...
class SystemMigrateOldHearingTest {
    ...
    void shouldSuccessfullyMigrateTheOldHearingPost() {
        ...
        //Then
        assertThat(response.getData().getHearingList()).isNotEmpty();
