...
class CaseworkerDocumentManagementAmendTest {
    ...
    void shouldSuccessfullyAmendCaseDocument() {
        ...
        assertThat(aboutToSubmitResponse.getData().getCicCase().getApplicantDocumentsUploaded().get(0).getValue().getDocumentCategory()).isEqualTo(DocumentType.APPLICATION_FORM);
        assertThat(documentMgmtResponse).isNotNull();
    }

    @Test
    void shouldSuccessfullyAmendOrderDocument() {
        //Given
        final CaseData caseData = caseData();
        final CicCase cicCase = CicCase.builder()
        ...
        cicCase.setSelectedDocumentType(DocumentConstants.ORDER_TYPE);
        ...
        //Then
        assertThat(aboutToSubmitResponse.getData().getCicCase().getOrderList().get(0).getValue()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCicCase().getOrderList().get(0)
            .getValue().getUploadedFile()
            .get(0).getValue().getDocumentLink().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }

    @Test
    void shouldSuccessfullyAmendOrderTemplateDocument() {
        //Given
        final CaseData caseData = caseData();
        final CicCase cicCase = CicCase.builder()
            .orderList(getOrderTemplateDocumentList())
            .build();
        caseData.setCicCase(cicCase);
        ...
        assertThat(aboutToSubmitResponse.getData().getCicCase().getOrderList().get(0).getValue()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCicCase().getOrderList().get(0)
            .getValue().getDraftOrder().getTemplateGeneratedDocument().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }
    ...
    @Test
    void shouldSuccessfullyAmendDecisionDocuments() {
        //Given
        final CaseData caseData = caseData();
        caseData.getCaseIssueDecision().setDecisionDocument(getCicDocumentData());
        final CicCase cicCase = CicCase.builder().build();
        caseData.setCicCase(cicCase);
        ...
        cicCase.setSelectedDocument(getCaseworkerCICDocument());
        cicCase.setSelectedDocumentType(DocumentConstants.DECISION_TYPE);
        ...
        //Then
        assertThat(aboutToSubmitResponse.getData().getCaseIssueDecision().getDecisionDocument()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCaseIssueDecision().getDecisionDocument()
            .getDocumentLink().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }

    @Test
    void shouldSuccessfullyAmendDecisionDraftDocuments() {
        //Given
        final CaseData caseData = caseData();
        caseData.getCaseIssueDecision().setIssueDecisionDraft(getDocumentData());
        final CicCase cicCase = CicCase.builder().build();
        caseData.setCicCase(cicCase);
        ...
        //Then
        assertThat(aboutToSubmitResponse.getData().getCaseIssueDecision().getIssueDecisionDraft()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCaseIssueDecision().getIssueDecisionDraft().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }

    @Test
    void shouldSuccessfullyAmendFinalDecisionDocuments() {
        //Given
        final CaseData caseData = caseData();
        caseData.getCaseIssueFinalDecision().setDocument(getCicDocumentData());
        final CicCase cicCase = CicCase.builder().build();
        caseData.setCicCase(cicCase);
        ...
        cicCase.setSelectedDocument(getCaseworkerCICDocument());
        cicCase.setSelectedDocumentType(DocumentConstants.FINAL_DECISION_TYPE);
        ...
        //Then
        assertThat(aboutToSubmitResponse.getData().getCaseIssueFinalDecision().getDocument()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCaseIssueFinalDecision().getDocument().getDocumentLink().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }

    @Test
    void shouldSuccessfullyAmendFinalDecisionDraftDocuments() {
        //Given
        final CaseData caseData = caseData();
        caseData.getCaseIssueFinalDecision().setFinalDecisionDraft(getDocumentData());
        final CicCase cicCase = CicCase.builder().build();
        caseData.setCicCase(cicCase);
        ...
        //Then
        assertThat(aboutToSubmitResponse.getData().getCaseIssueFinalDecision().getFinalDecisionDraft()).isNotNull();
        assertThat(aboutToSubmitResponse.getData().getCaseIssueFinalDecision().getFinalDecisionDraft().getCategoryId())
            .isEqualTo(DocumentType.APPLICATION_FORM.getCategory());
        assertThat(documentMgmtResponse).isNotNull();
    }
