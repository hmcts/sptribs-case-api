...
class PageBuilderTest {
    ...
    @Mock
    private Event.EventBuilder<CriminalInjuriesCompensationData, UserRole, State> eventBuilder;
    ...
    @InjectMocks
    private PageBuilder<CriminalInjuriesCompensationData> pageBuilder;
