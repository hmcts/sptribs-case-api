...
class EditNewOrderContentPageTest {

    @InjectMocks
    private EditNewOrderContentPage editNewOrderContentPage;
    ...
    void shouldAddAnonymityParagraphWhenAnonymityHasBeenApplied() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response = editNewOrderContentPage.midEvent(caseDetails, caseDetailsBefore);
