...
public class SystemCreateTestCaseTest {


    @InjectMocks
    private SystemCreateTestCase createTestCase;
    ...
    @Mock
    private CaseDataDocumentService documentsService;
    ...
    void shouldAddConfigurationToConfigBuilder() {
        ...
        assertThat(getEventsFrom(configBuilder).values())
            ...
            .contains("system-create-test-case");
    }
