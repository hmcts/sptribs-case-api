...
public class CaseworkerCreateHearingSummaryIT extends IntegrationTestBase {
    ...
    @Test
    void shouldClearHearingDateWhenCompletingOnlyListedHearing() throws Exception {
        final Listing listedHearing = getRecordListing();
        final List<ListValue<Listing>> hearingList = new ArrayList<>();
        hearingList.add(new ListValue<>("1", listedHearing));
        ...
        caseData.setCicCase(CicCase.builder()
            .hearingList(DynamicList.builder()
                ...
                .listItems(List.of(DynamicListElement.builder().label("1 - Final - 21 Apr 2023 10:00").build()))
                .build())
            .build());
        ...
        String response = mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                ...
                .header(AUTHORIZATION, TEST_AUTHORIZATION_TOKEN)
                .content(objectMapper.writeValueAsString(
                    callbackRequest(caseData, CASEWORKER_CREATE_HEARING_SUMMARY)))
                .accept(APPLICATION_JSON))
    ...
    @Test
    void shouldMoveHearingDateToNextListedWhenCompletingEarliestHearing() throws Exception {
    ...
    @Test
    void shouldSaveHearingRecordingToCaseDocumentsTableOnAboutToSubmit() throws Exception {
        ...
        CaseworkerCICDocumentUpload recordingUpload = CaseworkerCICDocumentUpload.builder()
            ...
            .documentEmailContent("recording")
            .build();
        ...
        final HearingSummary hearingSummary = HearingSummary.builder()
            .recFileUpload(List.of(new ListValue<>("recording-1", recordingUpload)))
            .build();
        final Listing listing = Listing.builder()
            .regionList(getMockedRegionData())
            .hearingVenues(getMockedHearingVenueData())
        ...
        var request = callbackRequest(caseData, CASEWORKER_CREATE_HEARING_SUMMARY);
        request.getCaseDetails().getData().put(
            "recFileUpload",
            objectMapper.convertValue(hearingSummary.getRecFileUpload(),Object.class)
        );
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                .contentType(APPLICATION_JSON)
                .header(SERVICE_AUTHORIZATION, TEST_AUTHORIZATION_TOKEN)
