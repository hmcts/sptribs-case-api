...
public class DocumentManagementSelectDocumentsIT extends IntegrationTestBase {
    ...
    @Test
    void shouldSetSelectedDocumentsOnMidEvent() throws Exception {
        final CaseData caseData = CaseData.builder()
            .cicCase(CicCase.builder()
                .applicantDocumentsUploaded(getCaseworkerCICDocumentList("test.pdf", APPLICATION_FORM))
                .amendDocumentList(DynamicList.builder()
        ...
        String response = mockMvc.perform(post(DOCUMENT_MANAGEMENT_SELECT_DOCUMENT_MID_EVENT_URL)
        ...
        assertThatJson(response)
            ...
            .isEqualTo(
                json(expectedResponse(DOCUMENT_MANAGEMENT_SELECT_DOCUMENT_MID_EVENT_RESPONSE)));
    }
}
