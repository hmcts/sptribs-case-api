...
public class CaseworkerCreateHearingSummaryIT {
    private static final String CASEWORKER_CREATE_HEARING_SUMMARY_RESPONSE =
        "classpath:caseworker-create-hearing-summary-response.json";
    ...
    @Test
    void shouldSuccessfullyCreateHearingSummary() throws Exception {
        ...
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
            ...
            .andExpect(
                status().isOk())
            .andExpect(
                content().json(expectedResponse(CASEWORKER_CREATE_HEARING_SUMMARY_RESPONSE))
            );
    }
}
