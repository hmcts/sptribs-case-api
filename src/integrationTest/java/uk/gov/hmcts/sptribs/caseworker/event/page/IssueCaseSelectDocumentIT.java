...
import static uk.gov.hmcts.sptribs.testutil.TestConstants.ISSUE_CASE_SELECT_DOCUMENT_MID_EVENT_URL;
...
public class IssueCaseSelectDocumentIT extends IntegrationTestBase {
    ...
    void shouldValidateThatDocumentIsSelectedInMidEvent() throws Exception {
        ...
        mockMvc.perform(post(ISSUE_CASE_SELECT_DOCUMENT_MID_EVENT_URL)
            ...
            .andExpect(
                status().isOk())
            .andExpect(
                content().json(expectedResponse(ISSUE_CASE_SELECT_DOCUMENT_RESPONSE))
            );
    }
}
