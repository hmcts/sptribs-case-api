...
public class ContactPartiesNotificationIT {
    ...
    class WhenCitizenDashboardDisabled {
        ...
        void shouldSendEmailToSubject() {
            ...
            when(notificationServiceCIC.sendEmail(notificationRequestCaptor.capture(),
                anyList(), eq(TEST_CASE_ID.toString()), eq(Party.SUBJECT))).thenReturn(NOTIFICATION_RESPONSE);
        ...
        void shouldSendEmailToApplicant() {
            ...
            when(notificationServiceCIC.sendEmail(notificationRequestCaptor.capture(),
                anyList(), eq(TEST_CASE_ID.toString()), eq(Party.APPLICANT))).thenReturn(NOTIFICATION_RESPONSE);
        ...
        void shouldSendEmailToRepresentative() {
            ...
            when(notificationServiceCIC.sendEmail(notificationRequestCaptor.capture(),
                anyList(), eq(TEST_CASE_ID.toString()), eq(Party.REPRESENTATIVE))).thenReturn(NOTIFICATION_RESPONSE);
            ...
            verify(notificationServiceCIC).sendEmail(notificationRequestCaptor.capture(),
                anyList(), eq(TEST_CASE_ID.toString()), eq(Party.REPRESENTATIVE));
        ...
        void shouldSendEmailToTribunalWithDocumentsAttached() {
            ...
            verify(notificationServiceCIC)
                .sendEmail(notificationRequestCaptor.capture(), anyList(), eq(TEST_CASE_ID.toString()), eq(Party.TRIBUNAL));
    ...
    class WhenCitizenDashboardEnabled {
        ...
        void shouldSendEmailToSubject() {
            ...
            assertThat(notificationRequest.getDestinationAddress())
                .isEqualTo("subject@email.com");
            assertThat(notificationRequest.getTemplate())
                .isEqualTo(CONTACT_PARTIES_EMAIL_NEW_CD);
            assertThat(notificationRequest.getTemplateVars())
                .containsAllEntriesOf(Map.of(
                    TRIBUNAL_NAME, CIC,
                    CIC_CASE_NUMBER, TEST_CASE_ID.toString(),
    ...
    private ContactPartiesDocuments getContactPartiesDocuments() {
        ...
        final DynamicListElement listItem = DynamicListElement
            .builder()
            .label(
                "[pdf.pdf A - Application Form](http://manage-case.demo.platform.hmcts.net/documents/0777a9cf-4be8-4664-baa2-9eb5563abaec/binary)")
