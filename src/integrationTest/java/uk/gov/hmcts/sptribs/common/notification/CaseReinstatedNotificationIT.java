...
public class CaseReinstatedNotificationIT extends IntegrationTestBase {
    ...
    void shouldSendEmailToSubject() {
        final CaseData data = CaseData.builder()
            .cicCase(CicCase.builder()
                ...
                .reinstateReason(ReinstateReason.OTHER)
                .build())
            .build();
        ...
        final Map<String, Object> expectedTemplateVars = Map.of(
            ...
            REINSTATE_REASON, "Other"
        );

        caseReinstatedNotification.sendToSubject(data, TEST_CASE_ID.toString());
    ...
    void shouldSendEmailToApplicant() {
        ...
        caseReinstatedNotification.sendToApplicant(data, TEST_CASE_ID.toString());
    ...
    void shouldSendEmailToRepresentative() {
        ...
        caseReinstatedNotification.sendToRepresentative(data, TEST_CASE_ID.toString());
    ...
    void shouldSendEmailToRespondent() {
        ...
        caseReinstatedNotification.sendToRespondent(data, TEST_CASE_ID.toString());
