...
@SpringBootTest
public class CaseworkerClearHearingOptionsFT extends FunctionalTestSuite {

    private static final String REQUEST =
        "classpath:request/casedata/ccd-callback-casedata-caseworker-clear-hearing-options-about-to-submit.json";
    private static final String RESPONSE =
        "classpath:responses/response-caseworker-clear-hearing-options-about-to-submit.json";
