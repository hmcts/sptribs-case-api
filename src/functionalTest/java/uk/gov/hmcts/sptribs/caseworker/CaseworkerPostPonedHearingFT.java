...
@SpringBootTest
public class CaseworkerPostPonedHearingFT extends FunctionalTestSuite {

    private static final String REQUEST = "classpath:request/casedata/ccd-callback-casedata.json";

    @Test
    public void shouldPostponedHearingSuccessfully() throws Exception {
        final Map<String, Object> caseData = caseData(REQUEST);

        final io.restassured.response.Response response =
            triggerCallback(caseData, EventConstants.CASEWORKER_POSTPONE_HEARING, ABOUT_TO_SUBMIT_URL);
