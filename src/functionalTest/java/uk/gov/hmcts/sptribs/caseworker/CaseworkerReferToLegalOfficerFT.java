...
@SpringBootTest
public class CaseworkerReferToLegalOfficerFT extends FunctionalTestSuite {

    private static final String CALLBACK_REQUEST =
        "classpath:request/casedata/ccd-callback-casedata-caseworker-refer-to-legal-officer-callback-request.json";

    private static final String REFERRAL_DATE = "$.data.referToLegalOfficerReferralDate";
