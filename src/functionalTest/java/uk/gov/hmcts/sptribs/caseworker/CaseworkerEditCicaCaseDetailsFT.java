...
public class CaseworkerEditCicaCaseDetailsFT extends FunctionalTestSuite {
    ...
    private static final String RESPONSE_ABOUT_TO_SUBMIT =
        "classpath:responses/response-caseworker-edit-cica-case-details-about-to-submit.json";

    private static final String CONFIRMATION_HEADER = "$.confirmation_header";

    @Test
    public void shouldInitialiseEditCicaCaseDetailsWhenAboutToSubmitCallbackIsInvoked() throws Exception {
        final Map<String, Object> caseData = caseData(CALLBACK_REQUEST);

        final Response response = triggerCallback(caseData, CASEWORKER_EDIT_CICA_CASE_DETAILS, ABOUT_TO_SUBMIT_URL);
