...
public class CaseworkerManageCaseFlagFT extends FunctionalTestSuite {
    ...
    @Test
    public void shouldSuccessfullyReturnValueWhenAboutToSubmitCallbackIsInvoked() throws Exception {
    ...
    @Test
    public void shouldTriggerSuccessfulResponseIfBadSubmittedCallbackIsInvoked() throws Exception {
        final Map<String, Object> caseData = caseData(CALLBACK_REQUEST);
