...
@SpringBootTest
public class CaseworkerManageOrderDueDataFT extends FunctionalTestSuite {

    private static final String REQUEST_ABOUT_TO_START =
        "classpath:request/casedata/ccd-callback-casedata-caseworker-manage-order-due-date-about-to-start.json";
    private static final String CALLBACK_REQUEST =
        "classpath:request/casedata/ccd-callback-casedata-caseworker-manage-order-due-date-callback-request.json";

    private static final String RESPONSE_ABOUT_TO_START =
        "classpath:responses/response-caseworker-manage-order-due-date-about-to-start.json";
    private static final String RESPONSE_ABOUT_TO_SUBMIT =
        "classpath:responses/response-caseworker-manage-order-due-date-about-to-submit.json";
