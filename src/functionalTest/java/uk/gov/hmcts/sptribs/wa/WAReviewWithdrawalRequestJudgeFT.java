...
@SpringBootTest
@Slf4j
public class WAReviewWithdrawalRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewWithdrawalRequestJudge";
    ...
    void shouldInitiateReviewWithdrawalRequestJudgeTask() {
