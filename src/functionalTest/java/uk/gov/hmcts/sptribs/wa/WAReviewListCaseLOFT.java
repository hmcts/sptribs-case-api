...
@SpringBootTest
@Slf4j
public class WAReviewListCaseLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewListCaseLO";
    ...
    void shouldInitiateReviewListCaseLOTask() throws IOException {
