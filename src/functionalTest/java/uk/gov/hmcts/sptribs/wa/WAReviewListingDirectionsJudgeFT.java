...
@SpringBootTest
@Slf4j
public class WAReviewListingDirectionsJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewListingDirectionsJudge";
    ...
    void shouldInitiateReviewListingDirectionsJudgeTask() {
