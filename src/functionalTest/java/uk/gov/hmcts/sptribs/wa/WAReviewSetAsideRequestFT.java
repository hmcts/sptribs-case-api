...
@SpringBootTest
@Slf4j
public class WAReviewSetAsideRequestFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewSetAsideRequest";
    ...
    void shouldInitiateReviewSetAsideRequestTask() {
