...
@SpringBootTest
@Slf4j
public class WAReviewReinstatementRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewReinstatementRequestJudge";
    ...
    void shouldInitiateReviewReinstatementRequestJudgeTask() {
