...
@SpringBootTest
@Slf4j
public class WAReviewTimeExtensionRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewTimeExtensionRequestJudge";
    ...
    void shouldInitiateReviewTimeExtensionRequestJudgeTask() {
