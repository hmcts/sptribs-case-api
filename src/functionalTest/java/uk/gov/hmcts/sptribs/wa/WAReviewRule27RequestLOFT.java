...
@SpringBootTest
@Slf4j
public class WAReviewRule27RequestLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewRule27RequestLO";
    ...
    void shouldInitiateReviewRule27RequestLOTask() {
