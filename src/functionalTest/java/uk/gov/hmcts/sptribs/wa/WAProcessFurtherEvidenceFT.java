...
@SpringBootTest
@Slf4j
public class WAProcessFurtherEvidenceFT extends FunctionalTestSuite {
    ...
    private static final String TASK_TYPE = "processFurtherEvidence";
    ...
    void shouldInitiateProcessFurtherEvidenceTaskOnCaseworkerDocumentManagementEvent() {
        ...
        ccdCaseCreator.createInitialStartEventAndSubmit(
            CASEWORKER_DOCUMENT_MANAGEMENT, ST_CIC_JURISDICTION, ST_CIC_CASE_TYPE, newCaseId, caseData);
