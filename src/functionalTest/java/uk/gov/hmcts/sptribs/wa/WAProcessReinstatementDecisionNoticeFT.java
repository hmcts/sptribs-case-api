...
@SpringBootTest
@Slf4j
public class WAProcessReinstatementDecisionNoticeFT extends FunctionalTestSuite {
    @Autowired
    ...
    void shouldInitiateProcessReinstatementDecisionNoticeTask() throws IOException, SQLException {
