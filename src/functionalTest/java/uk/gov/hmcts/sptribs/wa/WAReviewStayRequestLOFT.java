...
@SpringBootTest
@Slf4j
public class WAReviewStayRequestLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewStayRequestLO";
    ...
    void shouldInitiateReviewStayRequestLOTask() {
