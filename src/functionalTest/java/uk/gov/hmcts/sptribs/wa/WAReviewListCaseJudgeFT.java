...
@SpringBootTest
@Slf4j
public class WAReviewListCaseJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewListCaseJudge";
    ...
    void shouldInitiateReviewListCaseJudgeTask() throws IOException {
