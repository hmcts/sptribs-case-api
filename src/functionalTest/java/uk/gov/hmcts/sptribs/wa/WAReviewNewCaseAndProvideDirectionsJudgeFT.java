...
@SpringBootTest
@Slf4j
public class WAReviewNewCaseAndProvideDirectionsJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewNewCaseAndProvideDirectionsJudge";
    ...
    void shouldInitiateReviewNewCaseAndProvideDirectionsJudgeTask() {
        ...
        caseData.put("cicCaseReferralTypeForWA", "New case");
