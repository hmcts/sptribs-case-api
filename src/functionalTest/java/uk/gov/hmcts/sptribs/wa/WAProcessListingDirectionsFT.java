...
@SpringBootTest
@Slf4j
public class WAProcessListingDirectionsFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "processListingDirections";
    ...
    void shouldInitiateProcessListingDirectionsTask() throws IOException, SQLException {
        ...
        caseData.put("cicCaseReferralTypeForWA", "Listing directions");
