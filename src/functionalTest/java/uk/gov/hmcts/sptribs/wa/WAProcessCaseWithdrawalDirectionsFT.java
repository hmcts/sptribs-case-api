...
public class WAProcessCaseWithdrawalDirectionsFT extends FunctionalTestSuite {
    ...
    private static final String TASK_TYPE = "processCaseWithdrawalDirections";
    ...
    void shouldInitiateProcessCaseWithdrawalDirectionsTask() throws IOException, SQLException {
