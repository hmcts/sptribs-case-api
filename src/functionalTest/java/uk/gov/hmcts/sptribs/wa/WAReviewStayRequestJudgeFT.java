...
@SpringBootTest
@Slf4j
public class WAReviewStayRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewStayRequestJudge";
    ...
    void shouldInitiateReviewStayRequestJudgeTask() {
