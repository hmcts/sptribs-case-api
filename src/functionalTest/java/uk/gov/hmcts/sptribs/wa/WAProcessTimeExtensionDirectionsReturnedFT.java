...
@SpringBootTest
@Slf4j
public class WAProcessTimeExtensionDirectionsReturnedFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "processTimeExtensionDirectionsReturned";
