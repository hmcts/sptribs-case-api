...
@SpringBootTest
@Slf4j
public class WAReviewCorrectionsRequestFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewCorrectionsRequest";
    ...
    void shouldInitiateReviewCorrectionsRequestTask() {
