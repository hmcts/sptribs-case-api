...
@SpringBootTest
@Slf4j
public class WAReviewListCaseWithin5DaysJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewListCaseWithin5DaysJudge";
    ...
    void shouldInitiateReviewListCaseWithin5DaysJudgeTask() throws IOException {
