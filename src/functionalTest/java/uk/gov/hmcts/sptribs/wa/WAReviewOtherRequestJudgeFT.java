...
@SpringBootTest
@Slf4j
public class WAReviewOtherRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewOtherRequestJudge";
    ...
    void shouldInitiateReviewOtherRequestJudgeTask() {
