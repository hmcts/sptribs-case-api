...
@SpringBootTest
@Slf4j
public class WAReviewPostponementRequestLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewPostponementRequestLO";
    ...
    void shouldInitiateReviewPostponementRequestLOTask() throws IOException {
