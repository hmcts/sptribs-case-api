...
@SpringBootTest
@Slf4j
public class WAReviewStrikeOutRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewStrikeOutRequestJudge";
    ...
    void shouldInitiateReviewStrikeOutRequestJudgeTask() {
