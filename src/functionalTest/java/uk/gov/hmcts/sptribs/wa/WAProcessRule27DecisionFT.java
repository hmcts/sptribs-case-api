...
@SpringBootTest
@Slf4j
public class WAProcessRule27DecisionFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "processRule27Decision";
    ...
    void shouldInitiateProcessRule27DecisionTask() throws IOException, SQLException {
