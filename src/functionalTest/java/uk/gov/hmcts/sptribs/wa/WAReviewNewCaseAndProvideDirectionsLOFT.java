...
@SpringBootTest
@Slf4j
public class WAReviewNewCaseAndProvideDirectionsLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewNewCaseAndProvideDirectionsLO";
    ...
    void shouldInitiateReviewNewCaseAndProvideDirectionsLOTask() {
