...
@SpringBootTest
@Slf4j
public class WAReviewOtherRequestLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewOtherRequestLO";
    ...
    void shouldInitiateReviewOtherRequestLOTask() {
