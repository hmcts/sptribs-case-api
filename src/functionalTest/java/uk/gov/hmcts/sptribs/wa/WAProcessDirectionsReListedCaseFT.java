...
@SpringBootTest
@Slf4j
public class WAProcessDirectionsReListedCaseFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "processDirectionsReListedCase";
    ...
    void shouldInitiateProcessDirectionsReListedCaseTask() throws IOException {
        ...
        log.debug("Document response: status {}; body: {}", documentResponse.getStatusCode(), documentResponse.getBody());
