...
@SpringBootTest
@Slf4j
public class WAReviewPostponementRequestJudgeFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewPostponementRequestJudge";
    ...
    void shouldInitiateReviewPostponementRequestJudgeTask() throws IOException {
