...
@SpringBootTest
@Slf4j
public class WAReviewStrikeOutRequestLOFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "reviewStrikeOutRequestLO";
    ...
    void shouldInitiateReviewStrikeOutRequestLOTask() {
