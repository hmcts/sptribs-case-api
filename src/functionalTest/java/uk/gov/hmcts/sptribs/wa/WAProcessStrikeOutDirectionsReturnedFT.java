...
@SpringBootTest
@Slf4j
public class WAProcessStrikeOutDirectionsReturnedFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "processStrikeOutDirectionsReturned";
    ...
    void shouldInitiateProcessStrikeOutDirectionsReturnedTask() throws IOException, SQLException {
        ...
        caseData.put("cicCaseReferralTypeForWA", "Strike out request");
