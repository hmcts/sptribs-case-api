...
@SpringBootTest
@Slf4j
public class WAStitchCollateHearingBundleFT extends FunctionalTestSuite {
    @Autowired
    ...
    private static final String TASK_TYPE = "stitchCollateHearingBundle";
    ...
    void shouldInitiateStitchCollateHearingBundleTask() throws IOException {
        ...
        ccdCaseCreator.createInitialStartEventAndSubmitSystemEvent(
            SYSTEM_TRIGGER_STITCH_COLLATE_HEARING_BUNDLE, ST_CIC_JURISDICTION, ST_CIC_CASE_TYPE, newCaseId, caseData);
