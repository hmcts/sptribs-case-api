const finalDecisionMain_content = {
  pageHint: "Decision: Issue final decision",
  pageTitle: "Edit Final Decision",
...
A party is entitled to challenge any direction given by applying within a month for another direction which amends, suspends or sets aside the first direction`,
  strikeoutNotice: `On 7/12/2021 the Tribunal issued Directions for Mr/s Bloggs and there has been no reply.
...
It is possible to apply for this decision to be set aside and the appeal re-instated. This application must be in writing and received by the Tribunal within a month of issue of this notice.`,
...
export default finalDecisionMain_content;
