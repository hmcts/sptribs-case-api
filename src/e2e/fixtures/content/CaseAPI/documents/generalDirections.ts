const generalDirections = {
  ...
  textOnPage3: "Criminal Injuries Compensation",
  textOnPage4: "Criminal Injuries Compensation Schemes 1996 (the Scheme)",
  textOnPage5:
    "The Tribunal Procedure (First-tier Tribunal) (Social Entitlement Chamber) Rules",
  textOnPage6: "2008, as amended (the Rules)",
...
export default generalDirections;
