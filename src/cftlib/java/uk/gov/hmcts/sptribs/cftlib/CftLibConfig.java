...
public class CftLibConfig implements CFTLibConfigurer {
    ...
    public void configure(CFTLib lib) throws Exception {
        ...
        final List<String> roleList = List.of("caseworker",
            "caseworker-st_cic-caseworker",
            "pui-case-manager",
            "jrd-system-user",
            "jrd-admin");

        final Map<String, List<String>> users = Map.of(
        ...
        final String json = IOUtils.toString(resourceLoader.getResource("classpath:cftlib-am-role-assignments.json")
