...
public class CaseworkerAddNoteTest extends XuiTest {
    ...
    public void addNote() {
        ...
        assertThat(page).hasURL("http://localhost:3000/cases/case-create/ST_CIC/CriminalInjuriesCompensation/caseworker-create-case/create-test-applicationcaseCategorisationDetails");
    }
}
